               ...
               <div className="col-lg-6 col-md-6">
                   <div className="coupon_code right" data-aos="fade-up" data-aos-delay="400">
                       ...
                       <div className="coupon_inner">
                           ...
                           <div className="cart_subtotal ">
                               {
                                ...
                                <>
                                    <p>Coupan Discount</p>
                               <p className="cart_amount"><span></span> - ₹{Math.round(order.CoupanDiscountPrice)}</p>
                                </>
                               }
                           </div>
                           <div className="cart_subtotal ">
                               ...
                               <p className="cart_amount"><span></span> - ₹{order.WalletBalance}</p>
                                    </>:
                                        ""
                           ...
                           <div className="cart_subtotal ">
                               <p>Shipping</p>
                               <p className="cart_amount"><span></span>+ ₹40.00</p>
                           </div>
                           {/* <a href="#">Calculate shipping</a> */}
   
                           <div className="cart_subtotal">
                               <p>Total Amount</p>
                               <p className="cart_amount">₹{Math.round(order.totalPriceAfterDiscounts)}.00</p>
                           </div>
